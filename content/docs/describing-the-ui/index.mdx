...
<Callout>
### Вы узнаете [!toc]
* [Как написать свой первый компонент React](/docs/describing-the-ui/your-first-component)
* [Когда и как создавать файлы с несколькими компонентами](/docs/describing-the-ui/importing-and-exporting-components)
* [Как добавлять разметку в JavaScript с помощью JSX](/docs/describing-the-ui/writing-markup-with-jsx)
* [Как использовать фигурные скобки с JSX для доступа к функционалу JavaScript из ваших компонентов](/docs/describing-the-ui/javascript-in-jsx-with-curly-braces)
* [Как настраивать компоненты с помощью props](/docs/describing-the-ui/passing-props-to-a-component)
* [Как условно рендерить компоненты](/docs/describing-the-ui/conditional-rendering)
* [Как отображать несколько компонентов одновременно](/docs/describing-the-ui/rendering-lists)
* [Как избежать запутанных ошибок, сохраняя чистоту компонентов](/docs/describing-the-ui/keeping-components-pure)
* [Почему полезно представлять ваш интерфейс в виде дерева](/docs/describing-the-ui/understanding-your-ui-as-a-tree)
</Callout>
...
import { Example9 } from '../../../examples/example copy 9';
...

{
  ...
  filename: 'Gallery.js',
  lang: 'tsx',
  code: String.raw`import Profile from './Profile.js';
  ...
  filename: 'Profile.js',
  lang: 'ts',
  code: String.raw`export default function Profile() {
    return (
      <img
...
import { Example11 } from '../../../examples/example copy 11';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`export default function TodoList() {
    return (
      <>
...
/> */}
import { Example12 } from '../../../examples/example copy 12';
...
import { Example14 } from '../../../examples/example copy 14';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`function Item({ name, isPacked }) {
    return (
      <li className="item">
        {name} {isPacked && '✅'}
      </li>
...
import { Example16 } from '../../../examples/example copy 16';
...
import { Example17 } from '../../../examples/example copy 17';
