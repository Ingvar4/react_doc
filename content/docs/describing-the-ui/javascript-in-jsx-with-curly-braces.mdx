...
import { Example21 } from '../../../examples/example copy 21';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`export default function Avatar() {
    return (
      <img
        className="avatar"
        src="https://react.dev/images/docs/scientists/7vQD0fPs.jpg"
...
import { Example22 } from '../../../examples/example copy 22';
...
import { Example23 } from '../../../examples/example copy 23';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`const today = new Date();
...
import { Example24 } from '../../../examples/example copy 24';
