...
import { Example28 } from '../../../examples/example copy 28';
...
import { Example29 } from '../../../examples/example copy 29';
...
import { Example30 } from '../../../examples/example copy 30';
...
import { Example31 } from '../../../examples/example copy 31';
...
[Фигурные скобки открывают 'окно в мир JavaScript'.](/docs/describing-the-ui/javascript-in-jsx-with-curly-braces#using-curly-braces-a-window-into-the-javascript-world) Встройте переменную с фигурными скобками в возвращаемое дерево JSX, вложив ранее вычисленное выражение внутрь JSX:
