...
import { Example104 } from '../../../examples/example copy 104';
...

{
  ...
  filename: 'Section.js',
  lang: 'ts',
  code: String.raw`export default function Section({ children }) {
    return (
  ...
  filename: 'Heading.js',
  lang: 'ts',
  code: String.raw`export default function Heading({ level, children }) {
    switch (level) {
      case 1:
...
import { Example105 } from '../../../examples/example copy 105';
...
import { Example106 } from '../../../examples/example copy 106';
...

{
  ...
  filename: 'Section.js',
  lang: 'ts',
  code: String.raw`import { LevelContext } from './LevelContext.js';
...
import { Example107 } from '../../../examples/example copy 107';
