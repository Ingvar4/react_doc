...
import { Example102 } from '../../../examples/example copy 102';
...
import { Example103 } from '../../../examples/example copy 103';
...

{
  ...
  tab: 'utils',
  label: '',
  filename: 'taskReducer.js',
  lang: 'ts',
  code: String.raw`export default function tasksReducer(tasks, action) {
    switch (action.type) {
      case 'added': {
        return [
          ...tasks,
