...
React Compiler можно установить с помощью [нескольких инструментов сборки](/docs/react-compiler/installation), таких как Babel, Vite, Metro и Rsbuild.
...
* **[Установка](/docs/react-compiler/installation)** — Установите React Compiler и настройте его для ваших инструментов сборки
...
* **[Постепенное внедрение](/docs/react-compiler/incremental-adoption)** — стратегии постепенного внедрения компилятора в существующие кодовые базы
* **[Отладка и устранение неполадок](/docs/react-compiler/debugging)** — выявление и устранение проблем при использовании компилятора
