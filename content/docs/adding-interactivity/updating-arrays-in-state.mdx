    ...
    function handleClick() {
      const nextShapes = shapes.map(shape => {
        ...
        return shape;
          ...
          // Вернуть новый круг на 50 пикселей ниже
          return {
            ...shape,
            y: shape.y + 50,
          };
  ...
  export default function CounterList() {
    ...
    function handleIncrementClick(index) {
      const nextCounters = counters.map((c, i) => {
        if (i === index) {
          // Увеличить на единицу счетчик, по которому нажали
          return c + 1;
        } else {
...
`import { useState } from 'react';
  ...
  export default function BucketList() {
    ...
    return (
      <>
        <h1 style={{  fontSize: '15px' }}>Список произведений искусства, которые нужно увидеть</h1>
        <h2 style={{  fontSize: '13px' }}>Мой список произведений искусства, которые нужно увидеть:</h2>
        <ItemList
          artworks={myList}
          onToggle={handleToggleMyList} />
        <h2 style={{  fontSize: '13px' }}>Ваш список произведений искусства, которые нужно увидеть:</h2>
        <ItemList
          artworks={yourList}
...
`import { useState } from 'react';
  ...
  const [myList, setMyList] = useState(initialList);
    ...
    return (
      <>
        <h1 style={{  fontSize: '15px' }}>Список желаний в области искусства</h1>
        <h2 style={{  fontSize: '13px' }}>Мой список произведений искусства, которые я хочу увидеть:</h2>
        <ItemList
          artworks={myList}
          onToggle= {handleToggleMyList} />
        <h2 style={{  fontSize: '13px' }}>Ваш список произведений искусства, которые нужно увидеть:</h2>
