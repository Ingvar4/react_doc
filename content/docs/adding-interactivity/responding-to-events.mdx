...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`function AlertButton({ message, children }) {
    return (
...
import { Example46 } from '../../../examples/example copy 46';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`function Button({ onClick, children }) {
    return (
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`function Button({ onSmash, children }) {
    return (
...
import { Example47 } from '../../../examples/example copy 47';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`export default function Toolbar() {
    return (
...
import { Example48 } from '../../../examples/example copy 48';
...
import { Example49 } from '../../../examples/example copy 49';
...

{
  ...
  filename: 'App.js',
  lang: 'tsx',
  code: String.raw`export default function Signup() {
    return (
...
import { Example50 } from '../../../examples/example copy 50';
